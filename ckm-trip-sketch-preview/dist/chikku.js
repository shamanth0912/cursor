...
(function () {
  ...
  const CHIPS = ["Sketch my route", "Mullayanagiri", "Bengaluru distance", "2-day sketch", "Hebbe Falls", "Coffee", "Best months", "Sringeri"];
  ...
  function mount() {
    ...
    chips.addEventListener("click", (event) => {
      ...
      if (label === "Sketch my route" && window.CKMTripSketch) {
        const launch = root.querySelector("#ts-launch");
    ...
    if (window.CKMTripSketch && typeof window.CKMTripSketch.mountIntoChikku === "function") {
      window.CKMTripSketch.mountIntoChikku({
        root,
        push,
        openPanel: setOpen,
        dataReady,
