      ...
      <section class="page-hero">
        <div class="wrap">
          ...
          <p class="section-lead" style="margin-top:0.75rem">
            <a class="btn btn-dark shine t-learn" href="places-shelf.html" data-magnetic>${lang === "kn" ? "ಪುಸ್ತಕ ಶೆಲ್ಫ್ ನೋಟ" : "Open shelf view (preview)"}</a>
            <span class="micro" style="margin-left:0.75rem;opacity:0.75">${lang === "kn" ? "WebGL ಪೂರ್ವವೀಕ್ಷಣೆ — ಉತ್ಪಾದನೆಗೆ ಇನ್ನೂ ಅಲ್ಲ" : "WebGL preview — not production yet"}</span>
          </p>
